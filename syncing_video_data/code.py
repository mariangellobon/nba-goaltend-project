...
# --- FILE PATHS ---
# NOTE: put video/CSV next to this script or set paths to your files
video_path = str(_SCRIPT_DIR / "ball_pin_backboard_hard1_dataset3.mov")
data_path = str(_SCRIPT_DIR / "Mike_Dataset3.csv")
...
out = cv.VideoWriter(str(_SCRIPT_DIR / "ball_pin_backboard_hard1_dataset3_overlay3.mov"), fourcc, fps, (scale_width, scale_height))
