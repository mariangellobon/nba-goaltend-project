...
video_path = str(_SCRIPT_DIR / "layup_and_pin_hard_dataset1.mov")
data_path = str(_SCRIPT_DIR / "layup_and_pin_hard_datset1.csv")
...
out = cv.VideoWriter(str(_SCRIPT_DIR / "goaltend_layup_and_pin_hard_dataset1_overlay3.mov"), fourcc, round(fps / 2), (scale_width, scale_height))
